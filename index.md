...
features:
  ...
  - title: AniList Sync
    details: Optional AniList matching can pull cover art and keep chapter progress in sync with your manga list.
  - title: Cross-Platform Web App
    details: Poji runs in the browser, so there is no native app to install or platform-specific setup to manage.
---
